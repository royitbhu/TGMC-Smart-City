...
<head>
<title>Varanasi | Entertainment </title>
...
<div id="bd">
			...
			Apart from being a religious place, Varanasi offers a new experience
			for its visitors in various excursions and shopping in its exclusive 
			The Banarasi Sarees, carpets and other unique handicrafts items.  
<BR><BR>
            <A HREF="../../home.jsp">Varanasi</A> : Enjoy in Varanasi

<BR><BR>
<H1 ALIGN="CENTER">Having fun in Varanasi !!</H1>
        
        There are a number of historical and religious places and towns around
...
<!-- div id="hd">
    ...
    <div class="left-column">
        ...
        <script type="text/javascript" src="../../JS/entertainment_main.js"></script>
