...
Ext.ghats.SamplePanel = SamplePanel;
Ext.reg('samplespanel', Ext.ghats.SamplePanel);
})();
...
// Instantiate Ext.App instance
    ...
    var catalog = Ext.ghats.samplesCatalog;
    ...
    var store = new Ext.data.JsonStore({
        idProperty : 'id',
        fields     : ['id', 'title', 'ghats'],
        data       : catalog
    });

    var panel = new Ext.Panel({
        frame      : true,
        renderTo   : 'smart_city_content',
        height     : 350,
        autoScroll : true,
    ...
    var firebugWarning = function () {
        ...
        if(window.console && window.console.firebug && ! cp.get('hideFBWarning')){
            ...
            var newEl = tpl.insertFirst('smart_city_content');
