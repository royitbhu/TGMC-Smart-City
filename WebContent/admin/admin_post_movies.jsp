...
<link rel="stylesheet" type="text/css" href="../ext-3.1.0/resources/css/ext-all.css"/>
   <link rel="stylesheet" type="text/css" href="../CSS/fileuploadfield.css"/>
    ...
    Ext.onReady(function(){
        ...
        var bd = Ext.getBody();
        bd.createChild({tag: 'h2', html: 'Enter Movie Details here..'});
        var post_ads = new Ext.FormPanel({
            labelAlign: 'top',
            frame:true,
            title: 'Enter Movie Details here...',
...
/*
							...
							Ext.Msg.alert('Insertion Failed','Please fill in the essential details') ;
					}
                }
            	},{
            	text: 'Reset',
...
<script  type="text/javascript" src="./JS/mainmenu_hover_admin.js "></script><div id="content">
