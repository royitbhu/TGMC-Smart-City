        ...
        ({
					...
					if(sign_up_form.getForm().isValid()){						
						sign_up_form.getForm().submit({
							...
							window.location="./businessman/home.jsp";
	                        
	                    },
	                    failure:function(form, action) {
	                        Ext.MessageBox.alert('Message', 'Registration failed');
	                    }
							})
						}else{
...
<div id="content">
<h1 align="center">Sign Up as Businessman</h1><br><br>
