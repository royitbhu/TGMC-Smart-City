 ...
 */
public class updateRates extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       // String username= request.getParameter("username").toString();
        ...
        String current_price=request.getParameter("price").toString();
		...
		try {
			...
			try {
				...
				String updateMovies = "update market_rates set current_price='"+current_price+"' ,commodity='"+commodity+"'where category='"+category+"'";
