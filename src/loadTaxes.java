 ...
 */
public class loadTaxes extends HttpServlet {
...
//		        String details=request.getParameter("details").toString();
				...
				String query = "SELECT * FROM taxes where tax_name='"+tax_name+"'";
				...
				while(resultSet.next()){
					count++;
						String tax_name2=resultSet.getString(2);
						String paid_by2=resultSet.getString(3);
						...
						temp = temp+"{'tax_name':'"+tax_name2+"','paid_by':'"+paid_by2+"','details':'"+details2+"'},";
