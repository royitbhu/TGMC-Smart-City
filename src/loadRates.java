 ...
 */
public class loadRates extends HttpServlet {
...
//		        String price=request.getParameter("price").toString();
				...
				String query = "SELECT * FROM market_rates where category='"+category+"' and commodity='"+commodity+"'";
				...
				while(resultSet.next()){
					count++;
						String category2=resultSet.getString(2);
						String commodity2=resultSet.getString(3);
						String price2=resultSet.getString(4);
						...
						temp = temp+"{'category':'"+category2+"','commodity':'"+commodity+"','price':'"+price2+"'},";
